...
class historias1 extends BaseAdapter {
    /*variables globales
    ...
    int[] ima2;
    //generar constructor
    public historias1(Context context,int[] ima1, int[] ima2) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View vista = inflater.inflate(R.layout.imagenes,null);
        View vista2 = inflater.inflate(R.layout.imagenes,null);
